...
```{r}
MM2021_teams <- read_excel("~/Desktop/March_Madness2021.xlsx", sheet = "TeamStats", 
...
FirstRound <- read_xlsx("~/Desktop/March_Madness2021.xlsx", sheet = "FirstRound", col_types = types) # Type in Winners from FirstFour
SecondRound <- read_xlsx("~/Desktop/March_Madness2021.xlsx", sheet = "SecondRound", col_types = types)
Sweet16 <- read_xlsx("~/Desktop/March_Madness2021.xlsx", sheet = "Sweet16", col_types = types)
Elite8 <- read_xlsx("~/Desktop/March_Madness2021.xlsx", sheet = "Elite8", col_types = types)
FinalFour <- read_xlsx("~/Desktop/March_Madness2021.xlsx", sheet = "FinalFour", col_types = types)
Championship <- read_xlsx("~/Desktop/March_Madness2021.xlsx", sheet = "Championship", col_types = types)
...
This funntion will print the results in a meaningful way.
